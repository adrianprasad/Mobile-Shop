...
from mobileapp.models import Address,Category
...
class AddressForm(forms.ModelForm):
    class Meta:
        model = Address
        fields = [ 'city', 'state']
        widgets = {'city':forms.TextInput(attrs={'class':'form-control', 'placeholder':'City'}), 'state':forms.TextInput(attrs={'class':'form-control', 'placeholder':'State or Province'})}
